...
\begin{quote}\qquadČím více \texttt{druhů}, {\bfseries \itshape řezů}, velikostí, barev písma \textsf{a~jiných efektů} použijeme, tím \emph{profesionálněji} bude dokument vypadat. Čtenář tím {\tiny bude} vždy {\huge \bfseries nadšen!}\end{quote}
